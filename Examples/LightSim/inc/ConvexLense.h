...
private:
	...
	bool getLenseCollisionFactor(const QSFML::Utilities::Ray& ray, bool outgoingRay, float& smalestFactor, float &collisionNormal) const;
	...
	{
	public:
		LensePainter(ConvexLense* lense, const std::string& name = "LensePainter");
