...
private:
	...
	QSFML::vector<QSFML::Objects::GameObjectPtr> m_objs;
	QSFML::vector<QSFML::Objects::GameObjectPtr> m_collisionObjs;

	QSFML::Objects::GameObjectPtr m_performanceContainer;
	QSFML::vector<QSFML::Objects::GameObjectPtr> m_performanceObjs;
